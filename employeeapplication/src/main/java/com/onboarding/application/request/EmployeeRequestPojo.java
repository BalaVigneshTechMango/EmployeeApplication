...
public class EmployeeRequestPojo {
	...
	private List<HobbiesEntity> hobbiesEntities;
	private List<EducationEntity> educationEntities;
	private List<FamilyDetailsEntity> familyDetailsEntities;
	private List<PreviousEmploymentEntity> previousEmploymentEntity;
	...
	public List<FamilyDetailsEntity> getFamilyDetailsEntities() {
		return familyDetailsEntities;
	}

	public List<PreviousEmploymentEntity> getPreviousEmploymentEntity() {
		return previousEmploymentEntity;
	}
	...
	public void setFamilyDetailsEntities(List<FamilyDetailsEntity> familyDetailsEntities) {
		this.familyDetailsEntities = familyDetailsEntities;
	}

	public void setPreviousEmploymentEntity(List<PreviousEmploymentEntity> previousEmploymentEntity) {
		this.previousEmploymentEntity = previousEmploymentEntity;
	}
	...
	public List<HobbiesEntity> getHobbiesEntities() {
		return hobbiesEntities;
	}

	public void setHobbiesEntities(List<HobbiesEntity> hobbiesEntities) {
